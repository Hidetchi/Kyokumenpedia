...
** Run rails runner Game.update_relations manually to update positions-moves-games relation. Before doing this, check new Game data by tp Game.where(relation_update:false)
